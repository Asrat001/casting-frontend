...
const Baner = () => {
  return (
    <div className='  relative bg-gradient-to-tr  from-[#243046] to-green-400/70  min-h-screen  '>
   ...
   <h1 className='  text-[40px] sm:text-[70px]  balance  text-white'>you went Somting Uinque </h1>
         ...
         <Link to="/custome" className=' w-fit flex items-center justify-center bg-white p-2 mt-4 text-gray-700  font-Comfortaa gap-x-4 border-[4px] border-gray-800'>
