...
const Hero = () => {
  return (
    ...
    <main className= 'p-6 md:p-12 space-y-6'>
     ...
     <div className=' flex justify-center  items-center gap-x-3 sm:gap-x-3 mt-6'>
     <Link to='/custome' className=' w-1/2 h-12 p-2 border-[1px] rounded-lg text-[12px] s  border-gray-600  bg-gradient-to-r from-blue-600  to-[#3E8ED1]  font-semibold text-white flex gap-x-6 items-center justify-center'>
             Order Us <AiOutlineArrowRight className=' text-white'/>
        </Link>
  
            <Link to='/register' className=' w-1/2 h-12 p-2 rounded-lg border-[1px] text-[12px] font-semibold text-gray-800  border-[#3E8ED1] gap-x-6  bg-white flex items-center justify-center'>
              Registertion<AiOutlineArrowRight/>
            </Link>
