...
import { BsCash, BsFileMusic, BsFilm, BsPostageFill, BsSearch, BsServer } from "react-icons/bs";
     ...
     <p className="my-6 font-bold">
      1,200 Cast's
        ...
        <div className=" h-screen p-10 mt-[20px]">
          <h3 className=" text-black font-bold text-[30px] ">Why Energy Casting?</h3>
      <div className=" grid grid-cols-1 sm:grid-cols-2 p-16  ">
       ...
       <h3 className=" text-white my-4">Helps talents shine.</h3>
          <p className=" text-white text-[12px]">It provides a space for talents to learn and secure high-quality jobs.</p>
       </div>
        </div>
        <div className=" bg-[#F0F3F4] p-6   rounded-lg">
          ...
          <div>
            <h3 className=" text-black text-[16px] my-4">Helps producer find professional talents.</h3>
            <p className=" text-[12px]">It provides a space for talents to learn and secure high-quality jobs.</p>
          </div>
        </div>
        <div className=" bg-[#F0F3F4] p-6   rounded-lg">
          <div className="w-16 h-16 bg-[#ED7D31] rounded-full flex justify-center items-center">
          ...
          <div>
            <h3 className=" text-black text-[16px] my-4">Services are nearly free.</h3>
            <p className=" text-[12px]">It provides a space for talents to learn and secure high-quality jobs.</p>
          </div>
        </div>
        <div className=" bg-[#F0F3F4] p-6   rounded-lg">
          ...
          <div>
            <h3 className=" text-black text-[16px] my-4">Help producers get talents</h3>
            <p className=" text-[12px]">It provides a space for talents to learn and secure high-quality jobs.</p>
          </div>
        </div>
